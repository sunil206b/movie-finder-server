...
select id, title, description, year, release_date, runtime, rating, mpaa_rating,
...
select id, movie_id, genre_id, created_at, updated_at, g.id, g.genre_name, g.created_at,
...
insert into genres(id, genre_name, created_at, updated_at) values(1, Drama, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
values('The Shawshank Redemption', 'Two imprisoned men bond over a number of years',1994, '1994-10-14', 142, 5, 'R', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
--
insert into movies_genres(movie_id, genre_id, created_at, updated_at) values(1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
